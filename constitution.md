...
10.2 In cases where an appointment to the Management Committee is made by the members of the Management Committee, the Management Committee is recommended to hold a General Meeting (in the case of vacant Puisne Member positions, a vote without General Meeting per section 8.8 is also permitted) at the next available opportunity for members to vote on the appointment. This vote should afford no special preference to the appointee, and other Members of the Society will be able to nominate for the position in the same manner as any other General Meeting.
